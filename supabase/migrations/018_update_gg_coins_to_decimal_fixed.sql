...
-- Step 0: Drop existing functions first to avoid conflicts
DROP FUNCTION IF EXISTS credit_gg_coins(UUID, INTEGER, TEXT, TEXT, UUID, TEXT, JSONB);
DROP FUNCTION IF EXISTS credit_gg_coins(UUID, DECIMAL, TEXT, TEXT, UUID, TEXT, JSONB);
DROP FUNCTION IF EXISTS debit_gg_coins(UUID, INTEGER, TEXT, TEXT, UUID, TEXT, JSONB);
DROP FUNCTION IF EXISTS debit_gg_coins(UUID, DECIMAL, TEXT, TEXT, UUID, TEXT, JSONB);
...
-- Step 5: Create credit_gg_coins function to handle DECIMAL values
...
-- Step 6: Create debit_gg_coins function to handle DECIMAL values
