...
export const BadgeSocialShare: React.FC<BadgeSocialShareProps> = ({
  ...
  return (
    <div className={`${className}`}>
      <h3 className="text-lg font-semibold text-gray-900 mb-3">Share Your Achievement</h3>
      <p className="text-sm text-gray-600 mb-4">
        Let your friends know about your contribution to a carbon-negative Africa!
      </p>
      ...
      <button
        ...
        className="w-full mt-3 flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
      >
        {copied ? (
          <>
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
        <p className="text-xs text-gray-600 mb-1">Share with hashtags:</p>
        <div className="flex flex-wrap gap-2">
          <span className="text-xs font-medium text-blue-600">#GangGreen</span>
          <span className="text-xs font-medium text-blue-600">#GBM</span>
          <span className="text-xs font-medium text-blue-600">#ClimateAction</span>
        </div>
      </div>
    </div>
  );
