...
export function Navigation({ className = '' }: NavigationProps) {
  ...
  const footerItems = getFooterItems(user?.role); // NEW: Get footer items
  ...
  return (
    <>
      ...
      <nav
        className={`lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm ${className}`}
