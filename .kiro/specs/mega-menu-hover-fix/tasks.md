...
- [x] 1. Implement hover intent system in NavDropdown component
...
- [x] 2. Update mouse event handlers and container structure
...
- [x] 3. Test and verify hover behavior across viewports
